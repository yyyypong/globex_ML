...
% Implement GMM clustering and apply it with the K-means method to the
% dataset used in generated by the function myData0.
% Visualize the results by both GMM and K-means methods will all data points
% color coded, and compare the confusion matrices of both methods to confirm
% GMM achieves much better results than K-means in this particular case.
% You should:
% 1) Complete the function Kmeans
% 2) Complete the function MGClustering
clear, close all
global xmin xmax
